...
Conversation routing distinguishes greetings, conversation (including technical discussion), and tool-based work. A greeting starts a fresh dialogue segment; later casual turns stay in that segment until the user brings up earlier context. See [the design and evaluation report](docs/conversation-routing.md) for behavior, tests and limitations.
