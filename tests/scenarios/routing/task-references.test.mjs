...
routing({name: "任务里的短指代和纠正保留参数上下文", history: [
    ...
    {user: "第一个，执行吧", expect: {mode: "task", history: ["current", "recall"]}},
    {user: "不是，我说的是第二个", expect: {mode: "task", history: ["current", "recall"]}},
    {user: "继续刚才的任务，目标分支选第二个", expect: {mode: "task", history: ["current", "recall"]}},
    {user: "先别执行，等我确认", expect: {mode: "task", history: ["current", "recall"]}},
]});
