...
routing({name: "聊天里的指代词和比较继续当前话题", history: [
    ...
    {user: "那它有什么限制？", expect: {mode: "chat", history: "current"}},
    {user: "第一个吧", expect: {mode: "chat", history: "current"}},
    {user: "继续", expect: {mode: "chat", history: "current"}},
    {user: "那和 DeepSeek 比呢？", expect: {mode: "chat", history: "current"}},
    {user: "帮我查查它的官方说明", expect: {mode: "task", history: "current"}},
]});
